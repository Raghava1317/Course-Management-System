...
public class FacultyCreationAccount {
    ...
    private void insertFacultyIntoDB() {
        String sql = "insert into FacultyAccounts(id, lastname, firstname, username, password) values (?, ?, ?, ?, ?)";
        try {
            pstmt = Database.getConnection().prepareStatement(sql);
